...
INSERT INTO filahovet.fila (id, nome, codigo, situacao, sala_id) VALUES (1, 'Raio X', 'RX', 'ABERTA', 1);


INSERT INTO filahovet.senha (ordem, tipo, pet, tutor, situacao, fila_id) values (1, 'REGULAR', 'Tito', 'Thiago', 'ATENDIDA', 1);

INSERT INTO filahovet.senha (ordem, tipo, pet, tutor, situacao, fila_id) values (2, 'REGULAR', 'Lui', 'Luisa', 'ATENDIDA', 1);
