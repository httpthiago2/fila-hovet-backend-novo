...
@Getter
@Setter
public class VisualizacaoSenhaDTO {
    ...
    public VisualizacaoSenhaDTO(Senha senha) {
        this.senha = senha.getFila().getCodigo().concat(StringUtils.leftPad(senha.getOrdem().toString(), 3, '0'));
